...
# Shamelessly copied from https://github.com/Microsoft/azure-pipelines-task-lib/blob/045cdebde0cc14897ddcacd8de64a51c5898a975/powershell/VstsTaskSdk/LoggingCommandFunctions.ps1
# Adapted for PowerShell Core on Ubuntu by removing Console Colouring instructions
